...
/// The Custom card headline (the interval + days summary).
String _summary(WidgetTester tester) {
  // The headline is the only fontSize 15.5 / w600 white Text in the card.
  final texts = tester.widgetList<Text>(find.byType(Text));
  return texts
      .firstWhere((t) =>
          t.style?.fontSize == 15.5 &&
...
void main() {
  ...
  group('single vs multi day', () {
    testWidgets('interval 1 is multi-select', (tester) async {
      ...
      await tester.pump();
      expect(_summary(tester), 'Every month on the 9th and 14th');
  ...
  group('summary shapes', () {
    ...
    testWidgets('month shapes', (tester) async {
      ...
      // Every month on the 9th and 14th.
      for (var i = 0; i < 3; i++) {
        await tester.tap(find.byIcon(Icons.remove_rounded));
      }
      await tester.pump();
    ...
    testWidgets('the three-item join (commas + and)', (tester) async {
      ...
      await tester.pump();
      expect(_summary(tester), 'Every month on the 9th, 14th and 21st');
    });
